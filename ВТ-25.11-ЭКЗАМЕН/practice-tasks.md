# ПРАКТИЧЕСКИЕ ЗАДАЧИ - 30 БИЛЕТОВ
...
## КРИТЕРИИ ОЦЕНКИ КАЖДОЙ ЗАДАЧИ (по 100 баллам):

**Корректность (40 баллов)** - работает на всех тестовых случаях
**Качество кода (30 баллов)** - читаемость, структура, документация
**Оптимизация (20 баллов)** - правильная временная и пространственная сложность
**Тесты (10 баллов)** - покрытие edge cases, unit-тесты

**Оценка: 95-100 (5), 85-94 (4), 75-84 (3), <75 (2)**
