# C# LINQ: 100 Практических Заданий
...
### Категория 1: Where (Фильтрация) — Задания 1-10
...
### Категория 2: Select (Проекция) — Задания 11-20
...
### Категория 3: OrderBy/ThenBy (Сортировка) — Задания 21-30
...
### Категория 4: GroupBy (Группировка) — Задания 31-40
...
### Категория 5: Join (Объединение) — Задания 41-50
...
### Категория 6: Aggregate Functions (Агрегирование) — Задания 51-60
...
### Категория 7: Set Operations (Операции над множествами) — Задания 61-68
...
### Категория 8: Partitioning (Партиционирование) — Задания 69-76
...
### Категория 9: SelectMany (Разворачивание) — Задания 77-84
...
### Категория 10: Quantifiers (Проверка условий) — Задания 85-90
...
### Категория 11: Concatenation (Объединение) — Задания 91-94
...
### Категория 12: Casting (Приведение типов) — Задания 95-98
...
### Категория 13: Complex Queries (Сложные запросы) — Задания 99-100
