...
## Раздел 4: Свойства (Задачи 46-60)
...
86. Создайте класс `Person` с конструктором, принимающим имя и возраст.
...
## Задача 2: Создание класса Person с объектом (Задача #5)
