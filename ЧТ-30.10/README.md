# 100 Заданий по наследованию, доступу и полиморфизму в C#
...
## Раздел 4: Приведение к базовому типу (Upcast) (Задачи 46-55)
...
## Раздел 8: Использование герметизированных классов (Задачи 91-100)
