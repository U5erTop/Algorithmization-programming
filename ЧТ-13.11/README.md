# C# Задания: Обобщения (Generics), Ковариантность, Nullable типы, Операции поглощения

---

## Раздел 1: Обобщения (Generics) 
...
## Раздел 2: Ковариантность и контрвариантность обобщений
...
## Раздел 4: Операции поглощения (Null-coalescing operations) 
